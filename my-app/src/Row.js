...
function Row({ title, fetchUrl,isLargeRow }) {
  ...
  /* The URLSearchParams API provides a consistent interface to the bits and pieces of the URL 
  and allows trivial manipulation of the query string (that stuff after "?"). */
